...
public boolean existsByNome(String nome) {
 ...
 public boolean existsByQuantidade(BigDecimal quantidade){
       return produtoRepository.existsByQuantidade(quantidade);
   }
 public boolean existsByValor(BigDecimal valor){
        return produtoRepository.existsByValor(valor);
   }
